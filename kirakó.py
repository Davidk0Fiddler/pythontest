...
def main():
    ...
    pygame.display.set_caption('Kirakó')
    BASICFONT = pygame.font.Font('freesansbold.ttf', BASICFONTSIZE)

    RESET_SURF, RESET_RECT = makeText(
        'Visszaállítás',    TEXT, BGCOLOR, win_width - 120, win_height - 310)
    NEW_SURF,   NEW_RECT = makeText(
        'Új játék', TEXT, BGCOLOR, win_width - 120, win_height - 280)
    SOLVE_SURF, SOLVE_RECT = makeText(
        'Megoldás',    TEXT, BGCOLOR, win_width - 120, win_height - 250)
    ...
    while True:
        ...
        msg = 'Nyomj a kockára, vagy használdd a nyilakat hogy mozgathasdd!'
        ...
        if slideTo:
            ...
            sliding_animation(
                mainBoard, slideTo, 'Nyomj a kockára, vagy használdd a nyilakat hogy mozgathasdd!', 8)
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        sliding_animation(board, move, 'Új kirakó készítése...',
